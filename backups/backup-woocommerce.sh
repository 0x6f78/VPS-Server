...
ENV_FILE="$HOME/vps-server/apps/woocomerce/.env"
BACKUP_DIR="$HOME/vps-server/backups/woocomerce"
PROJECT_ROOT="$HOME/vps-server/apps/woocomerce"
...
echo -e "\033[0;35m[INFO] Archiving Woocomerce files...\033[0m"
